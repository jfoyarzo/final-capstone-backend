...
RSpec.describe V1::AppointmentsController, type: :request do
  before(:each) do
    ...
    @appointment = Appointment.create!(id: 1, user_id: 2, investigator_id: 1, date: '2024-01-01 12:00', city: 'New York, NY')
    sign_in @user
  end
  ...
  describe 'POST #create' do
    it 'returns http success' do
      post '/v1/appointments', params: { appointment: { user_id: 2, investigator_id: 1, date: '2024-01-01 12:00', city: 'New York, NY' } }
      expect(response).to have_http_status(:success)
    end
  end
